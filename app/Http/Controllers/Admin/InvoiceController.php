...
class InvoiceController extends Controller
{
    public function index(Request $request)
    {
        ...
        {   
            ...
            $response       = Invoice::getInvoiceModel($limit, $page, $orderby, $order, $search_field , $search_type, $search_value);
            ...
            foreach ($invoices as $invoice) {
                ...
                $actions            = view('admin.invoices.actions',['id' => $invoice->id,'status'=>$invoice->status]);
    ...
    public function transaction(Request $request)
    {
        ...
        EmailProvider::sendMail('transaction-mail', 
            [   
                'name' => Auth::user()->name,
