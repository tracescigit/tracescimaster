...
class Code extends Model
{
	...
	protected $fillable = ['product_id','batch','batch_id','qr_code','url','user_id','status','code_data','exported','aggregation_id','order_id','secret_code','deactivate_reason','deactivated_at','deactivated_by'];
