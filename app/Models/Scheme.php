...
class Scheme extends Model
{
    ...
    public static function getSchemeModel($limit, $page, $orderby, $order , $search_field , $search_type, $search_value)
    {
        $q = Scheme::where('user_id', Auth::user()->parent_id??Auth::id());
