  ...
  jQuery.extend(!0, t, {
    ...
    animateSingleCaption: function (a, n, r, u, w, y, b) {
      ...
      if (('slide' === R && ((r = 0), (u = 0)), a.hasClass('tp-videolayer') || a.find('iframe').length > 0 || a.find('video').length > 0)) {
        ...
        var Z,
          O = p(a.data('videowidth'), n)[n.curWinRange] || p(a.data('videowidth'), n) || 'auto',
      ...
      var sa = a.data('lasttriggerstate'),
        ...
        ma = ea + u,
        ua = a.css('z-Index');
      b || ('reset' == sa && 'bytrigger' != pa ? (a.data('triggerstate', 'on'), a.data('animdirection', 'in'), (la = 'on')) : 'reset' == sa && 'bytrigger' == pa && (a.data('triggerstate', 'off'), a.data('animdirection', 'out'), (la = 'off'))),
        punchgs.TweenLite.set(L, { zIndex: ua, top: ma, left: ga, overwrite: 'auto' }),
        0 == T && (x = !0),
        void 0 == a.data('timeline') || x || (2 != T && a.data('timeline').gotoAndPlay(0), (x = !0)),
        !y && a.data('timeline_out') && 2 != T && 0 != T && (a.data('timeline_out').kill(), a.data('outstarted', 0)),
        b && void 0 != a.data('timeline') && (a.removeData('$anims'), a.data('timeline').pause(0), a.data('timeline').kill(), void 0 != a.data('newhoveranim') && (a.data('newhoveranim').progress(0), a.data('newhoveranim').kill()), a.removeData('timeline'), punchgs.TweenLite.killTweensOf(a), a.unbind('hover'), a.removeClass('rs-hover-ready'), a.removeData('newhoveranim'));
      ...
      if (((fa = jQuery.isNumeric(fa) ? fa : 0), wa.pause(), (1 > fa && 1 != a.data('outstarted')) || 2 == T || b)) {
        ...
        if ((void 0 != a.data('mySplitText') && a.data('mySplitText').revert(), (void 0 != a.data('splitin') && a.data('splitin').match(/chars|words|lines/g)) || (void 0 != a.data('splitout') && a.data('splitout').match(/chars|words|lines/g)))) {
          ...
          a.data('mySplitText', new punchgs.SplitText(ba, { type: 'lines,words,chars', charsClass: 'tp-splitted', wordsClass: 'tp-splitted', linesClass: 'tp-splitted' })), a.addClass('splitted');
        }
        ...
        if (!a.data('$anims') || b || Ta) {
          ...
          (Wa = s(Wa, a.data('transform_idle'))),
            (La = s(Wa, a.data('transform_in'), 1 == n.sdir)),
            ja && ((Ca = s(Ca, a.data('transform_hover'))), (Ca = c(Ca, a.data('style_hover'))), a.data('hover', Ca)),
            (La.elemdelay = void 0 == a.data('elementdelay') ? 0 : a.data('elementdelay')),
            (Wa.anim.ease = La.anim.ease = La.anim.ease || punchgs.Power1.easeInOut),
            ja &&
        ...
        if (((xa.f.anim.x = xa.f.anim.x * n.bw || d(xa.f.anim.x, n, ta, ia, ma, ga, 'horizontal')), (xa.f.anim.y = xa.f.anim.y * n.bw || d(xa.f.anim.y, n, ta, ia, ma, ga, 'vertical')), 2 != T || b)) {
          ...
          if (
            ((xa.f.anim.visibility = 'hidden'),
            Ra.eventCallback('onStart', function () {
            ...
            'sliderenter' == pa && n.overcontainer && (ca = 0.6),
            wa.add(Ra.staggerFromTo(ya, xa.f.speed, xa.f.anim, xa.r.anim, xa.f.elemdelay), ca),
            Ia)
          ) {
            var _a = new Object();
        ...
        a.data('timeline', wa),
          (n.sliderscrope = void 0 === n.sliderscrope ? Math.round(99999 * Math.random()) : n.sliderscrope),
          (T = h(a, n, 'in')),
          (0 !== fa && 2 != T) || 'bytrigger' === ha || b || 'sliderleave' == ha || (void 0 == ha || (-1 != T && 2 != T) || 'bytriger' === ha ? punchgs.TweenLite.delayedCall(999999, t.endMoveCaption, [a, C, L, n], n.sliderscrope) : punchgs.TweenLite.delayedCall(parseInt(a.data('end'), 0) / 1e3, t.endMoveCaption, [a, C, L, n], n.sliderscrope)),
          (wa = a.data('timeline')),
          'on' == a.data('loopanimation') && f(W, n.bw),
          ('sliderenter' != pa || ('sliderenter' == pa && n.overcontainer)) && (-1 == T || 1 == T || b || (0 == T && 1 > fa && a.hasClass('rev-static-visbile'))) && ((1 > fa && fa > 0) || (0 == fa && 'bytrigger' != pa && 'keep' != sa) || (0 == fa && 'bytrigger' != pa && 'keep' == sa && 'on' == la) || ('bytrigger' == pa && 'keep' == sa && 'on' == la)) && (wa.resume(va), t.toggleState(a.data('layertoggledby')));
      }
      'on' == a.data('loopanimation') && punchgs.TweenLite.set(W, { minWidth: ta, minHeight: ia }), 0 == a.data('slidelink') || (1 != a.data('slidelink') && !a.hasClass('slidelink')) ? (punchgs.TweenLite.set(C, { width: 'auto', height: 'auto' }), a.data('slidelink', 0)) : (punchgs.TweenLite.set(C, { width: '100%', height: '100%' }), a.data('slidelink', 1));
    },
    endMoveCaption: function (a, e, t, o) {
      ...
      (g.anim.x = g.anim.x * o.bw || d(g.anim.x, o, v, f, w.top, w.left, 'horizontal')),
        (g.anim.y = g.anim.y * o.bw || d(g.anim.y, o, v, f, w.top, w.left, 'vertical')),
        ...
        r.add(p.staggerTo(m, g.speed, g.anim, u), 0),
        y ? ((y.anim.ease = g.anim.ease), (y.anim.overflow = 'hidden'), (y.anim.x = y.anim.x * o.bw || d(y.anim.x, o, v, f, w.top, w.left, 'horizontal')), (y.anim.y = y.anim.y * o.bw || d(y.anim.y, o, v, f, w.top, w.left, 'vertical')), r.add(h.to(e, g.speed, y.anim, u), 0)) : r.add(h.set(e, { overflow: 'visible', overwrite: 'auto' }, u), 0),
        a.data('timeline_out', r);
    },
    removeTheCaptions: function (a, e) {
      ...
      e.layers[i] &&
        ...
        punchgs.TweenLite.killDelayedCallsTo(t.endMoveCaption, !1, e.sliderscrope),
        n &&
  ...
  var i = function () {
    ...
    d = function (a, e, t, i, n, o, r) {
      return (
        !jQuery.isNumeric(a) && a.match(/%]/g)
          ...
          : ((a = 'layer_left' === a ? 0 - t : 'layer_right' === a ? t : a), (a = 'layer_top' === a ? 0 - i : 'layer_bottom' === a ? i : a), (a = 'left' === a || 'stage_left' === a ? 0 - t - o : 'right' === a || 'stage_right' === a ? e.conw - o : 'center' === a || 'stage_center' === a ? e.conw / 2 - t / 2 - o : a), (a = 'top' === a || 'stage_top' === a ? 0 - i - n : 'bottom' === a || 'stage_bottom' === a ? e.conh - n : 'middle' === a || 'stage_middle' === a ? e.conh / 2 - i / 2 - n : a)),
        a
      );
    },
    s = function (a, e, t) {
        ...
        n &&
          jQuery.each(n, function (a, e) {
            var n = e.split(':'),
              o = n[0],
              d = n[1];
            t && void 0 != d && d.length > 0 && d.match(/\(R\)/) && ((d = d.replace('(R)', '')), (d = 'right' === d ? 'left' : 'left' === d ? 'right' : 'top' === d ? 'bottom' : 'bottom' === d ? 'top' : d), '[' === d[0] && '-' === d[1] ? (d = d.replace('[-', '[')) : '[' === d[0] && '-' !== d[1] ? (d = d.replace('[', '[-')) : '-' === d[0] ? (d = d.replace('-', '')) : d[0].match(/[1-9]/) && (d = '-' + d)),
              void 0 != d &&
                ((d = d.replace(/\(R\)/, '')),
                ('rotationX' == o || 'rX' == o) && (i.anim.rotationX = r(d, i.anim.rotationX) + 'deg'),
                ('rotationY' == o || 'rY' == o) && (i.anim.rotationY = r(d, i.anim.rotationY) + 'deg'),
                ('rotationZ' == o || 'rZ' == o) && (i.anim.rotation = r(d, i.anim.rotationZ) + 'deg'),
                ('scaleX' == o || 'sX' == o) && (i.anim.scaleX = r(d, i.anim.scaleX)),
                ('scaleY' == o || 'sY' == o) && (i.anim.scaleY = r(d, i.anim.scaleY)),
                ('opacity' == o || 'o' == o) && (i.anim.opacity = r(d, i.anim.opacity)),
                ('skewX' == o || 'skX' == o) && (i.anim.skewX = r(d, i.anim.skewX)),
                ('skewY' == o || 'skY' == o) && (i.anim.skewY = r(d, i.anim.skewY)),
                'x' == o && (i.anim.x = r(d, i.anim.x)),
                'y' == o && (i.anim.y = r(d, i.anim.y)),
                'z' == o && (i.anim.z = r(d, i.anim.z)),
                ('transformOrigin' == o || 'tO' == o) && (i.anim.transformOrigin = d.toString()),
                ('transformPerspective' == o || 'tP' == o) && (i.anim.transformPerspective = parseInt(d, 0)),
                ('speed' == o || 's' == o) && (i.speed = parseFloat(d) / 1e3),
                ('ease' == o || 'e' == o) && (i.anim.ease = d));
          }),
        i
      );
    },
    ...
    g = function (a, e) {
      ...
      if (
        ...
        (i.letterSpacing = n ? (void 0 === t.data('letterspacing') ? parseFloat(t.css('letterSpacing'), 0) || 0 : t.data('letterspacing')) : void 0 === a.data('letterspacing') ? parseFloat(a.css('letterSpacing')) || 0 : a.data('letterspacing')),
    ...
    v = function (a, e, t, i) {
      ...
      if (('off' === i && ((r = 1), (d = 1)), 'auto' == o.lineHeight && (o.lineHeight = o.fontSize + 4), !a.hasClass('tp-splitted'))) {
        ...
        if (
          ...
          punchgs.TweenLite.set(a, { maxWidth: h, maxHeight: c, minWidth: v, minHeight: f, whiteSpace: o.whiteSpace, overwrite: 'auto' }), 'nopredefinedcolor' != o.color && punchgs.TweenLite.set(a, { color: o.color, overwrite: 'auto' });
        }
        setTimeout(function () {
