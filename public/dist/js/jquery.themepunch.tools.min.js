  ...
  if (!i.TweenLite) {
      ...
      var i,
        ...
        v = function (t) {
          var e,
            a,
            o = S() - x;
          o > m && (u += o - p), (x += o), (h.time = (x - u) / 1e3), (e = h.time - l), (!i || e > 0 || t === !0) && (h.frame++, (l += e + (e >= n ? 0.004 : n - e)), (a = !0)), t !== !0 && (r = s(v)), a && h.dispatchEvent(d);
        };
      b.call(h),
        (h.time = h.frame = 0),
        (h.tick = function () {
    ...
    C(),
      ...
      (n.paused = function (t) {
        ...
        var e,
          ...
          s = this._timeline;
        return (
          t != this._paused && s && (o || t || a.wake(), (e = s.rawTime()), (i = e - this._pauseTime), !t && s.smoothChildTiming && ((this._startTime += i), this._uncache(!1)), (this._pauseTime = t ? e : null), (this._paused = t), (this._active = this.isActive()), !t && 0 !== i && this._initted && this.duration() && ((e = s.smoothChildTiming ? this._totalTime : (e - this._startTime) / this._timeScale), this.render(e, e === this._totalTime, !0))), this._gc && !t && this._enabled(!0, !1), this
        );
      });
    ...
    var z = [],
      ...
      j = function (t, e, i, s, r, n, a, o) {
        var l,
          ...
          c = { t: t, p: e, s: _, f: 'function' === u, pg: 0, n: r || e, r: n, pr: 0, c: f ? parseInt(s.charAt(0) + '1', 10) * parseFloat(s.substr(2)) : parseFloat(s) - _ || 0 };
        return (
          'number' !== u && ('function' === u && 'get' === i && ((h = e.indexOf('set') || 'function' != typeof t['get' + e.substr(3)] ? e : 'get' + e.substr(3)), (c.s = _ = a ? t[h](a) : t[h]())), 'string' == typeof _ && (a || isNaN(_)) ? ((c.fp = a), (l = U(_, s, o || I.defaultStringFilter, c)), (c = { t: l, p: 'setRatio', s: 0, c: 1, f: 2, pg: 0, n: r || e, pr: 0 })) : f || (c.c = parseFloat(s) - parseFloat(_) || 0)),
    ...
    var W = function (t, e, i) {
        var s,
          r,
          n = t._gsTweenID;
        if ((q[n || (t._gsTweenID = n = 't' + B++)] || (q[n] = { target: t, tweens: [] }), e && ((s = q[n].tweens), (s[(r = s.length)] = e), i))) for (; --r > -1; ) s[r] === e && s.splice(r, 1);
        return q[n].tweens;
      },
      X = function (t, e, i, s) {
        var r,
      ...
      (n.render = function (t, e, i) {
        ...
        if (t >= l)
          ...
          var u = t / l,
            f = this._easeType,
            c = this._easePower;
          (1 === f || (3 === f && u >= 0.5)) && (u = 1 - u), 3 === f && (u *= 2), 1 === c ? (u *= u) : 2 === c ? (u *= u * u) : 3 === c ? (u *= u * u * u) : 4 === c && (u *= u * u * u * u), (this.ratio = 1 === f ? 1 - u : 2 === f ? u : 0.5 > t / l ? u / 2 : 1 - u / 2);
        ...
        (d.render = function (t, e, i) {
          ...
          if (t >= f) (this._totalTime = this._time = f), this._reversed || this._hasPausedChild() || ((n = !0), (o = 'onComplete'), (l = !!this._timeline.autoRemoveChildren), 0 === this._duration && (0 === t || 0 > this._rawPrevTime || this._rawPrevTime === r) && this._rawPrevTime !== t && this._first && ((l = !0), this._rawPrevTime > r && (o = 'onReverseComplete'))), (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : r), (t = f + 1e-4);
            ...
            if (this._hasPause && !this._forcingPlayhead && !e) {
              if (t >= c) for (s = this._first; s && t >= s._startTime && !u; ) s._duration || 'isPause' !== s.data || s.ratio || (0 === s._startTime && 0 === this._rawPrevTime) || (u = s), (s = s._next);
    ...
    function (t) {
      ...
      return (
        ...
        (i = h(
          ...
          function (e) {
            e = e || {};
            for (var i, s, r, n, a, o, h = e.taper || 'none', l = [], _ = 0, u = 0 | (e.points || 20), f = u, p = e.randomize !== !1, m = e.clamp === !0, d = e.template instanceof t ? e.template : null, g = 'number' == typeof e.strength ? 0.4 * e.strength : 0.4; --f > -1; )
              (i = p ? Math.random() : (1 / u) * f), (s = d ? d.getRatio(i) : i), 'none' === h ? (r = g) : 'out' === h ? ((n = 1 - i), (r = n * n * g)) : 'in' === h ? (r = i * i * g) : 0.5 > i ? ((n = 2 * i), (r = 0.5 * n * n * g)) : ((n = 2 * (1 - i)), (r = 0.5 * n * n * g)), p ? (s += Math.random() * r - 0.5 * r) : f % 2 ? (s += 0.5 * r) : (s -= 0.5 * r), m && (s > 1 ? (s = 1) : 0 > s && (s = 0)), (l[_++] = { x: i, y: s });
            for (
              l.sort(function (t, e) {
                return t.x - e.x;
              }),
    ...
    function (t, e) {
      ...
      var u,
        ...
        K = function (t, e) {
          var i,
            ...
            n = {};
          if ((e = e || H(t, null)))
            if ((i = e.length)) for (; --i > -1; ) (s = e[i]), (-1 === s.indexOf('-transform') || Se === s) && (n[s.replace(O, k)] = e.getPropertyValue(s));
            ...
            null == t
              ...
              : 'number' == typeof t
                ...
                : ((s = 360),
                  ...
                  n.length && (r && (r[i] = e + a), -1 !== t.indexOf('short') && ((a %= s), a !== a % (s / 2) && (a = 0 > a ? a + s : a - s)), -1 !== t.indexOf('_cw') && 0 > a ? (a = ((a + 9999999999 * s) % s) - (0 | (a / s)) * s) : -1 !== t.indexOf('ccw') && a > 0 && (a = ((a - 9999999999 * s) % s) - (0 | (a / s)) * s)),
                  (o = e + a)),
            h > o && o > -h && (o = 0),
            o
          );
          ...
          if (t)
            if ('number' == typeof t) i = [t >> 16, 255 & (t >> 8), 255 & t];
              ...
              if ((',' === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), oe[t])) i = oe[t];
                ...
                } else (a = (Number(i[0]) % 360) / 360), (o = Number(i[1]) / 100), (l = Number(i[2]) / 100), (s = 0.5 >= l ? l * (o + 1) : l + o - l * o), (r = 2 * l - s), i.length > 3 && (i[3] = Number(t[3])), (i[0] = le(a + 1 / 3, r, s)), (i[1] = le(a, r, s)), (i[2] = le(a - 1 / 3, r, s));
              else i = t.match(m) || oe.transparent;
              (i[0] = Number(i[0])), (i[1] = Number(i[1])), (i[2] = Number(i[2])), i.length > 3 && (i[3] = Number(i[3]));
            }
          else i = oe.black;
          return e && !c && ((r = i[0] / 255), (s = i[1] / 255), (n = i[2] / 255), (h = Math.max(r, s, n)), (u = Math.min(r, s, n)), (l = (h + u) / 2), h === u ? (a = o = 0) : ((f = h - u), (o = l > 0.5 ? f / (2 - h - u) : f / (h + u)), (a = h === r ? (s - n) / f + (n > s ? 6 : 0) : h === s ? (n - r) / f + 2 : (r - s) / f + 4), (a *= 60)), (i[0] = 0 | (a + 0.5)), (i[1] = 0 | (100 * o + 0.5)), (i[2] = 0 | (100 * l + 0.5))), i;
        }),
        ue = function (t, e) {
          var i,
            r,
          ...
          return u
            ? (s = e
                ? function (t) {
                    ...
                    if (((e = (t.match(fe) || [n])[0]), (c = t.split(e).join('').match(v) || []), (_ = c.length), u > _--)) for (; u > ++_; ) c[_] = i ? c[0 | ((_ - 1) / 2)] : a[_];
        ...
        de =
          ((E._parseToProxy = function (t, e, i, r, s, n) {
            ...
            for (i._transform = null, F = e, r = u = i.parse(t, e, r, s), F = d, n && ((i._transform = p), f && ((f._prev = null), f._prev && (f._prev._next = null))); r && r !== f; ) {
              if (1 >= r.type && ((o = r.p), (_[o] = r.s + r.c), (c[o] = r.s), n || ((h = new pe(r, 's', o, h, r.r)), (r.c = 0)), 1 === r.type)) for (a = r.l; --a > 0; ) (l = 'xn' + a), (o = r.p + '_' + l), (_[o] = r.data[l]), (c[o] = r[l]), n || (h = new pe(r, l, o, h, r.rxp[l]));
              r = r._next;
            }
              ...
              (P = ',' === d.charAt(d.length - 1) ? '),' : ')'),
                ...
                T && !W && 0 === d[3]
                  ...
                  : (W || (T = !1),
                    S
                      ? a
                          .appendXtra(T ? 'hsla(' : 'hsl(', p[0], se(d[0], p[0]), ',', !1, !0)
                          .appendXtra('', p[1], se(d[1], p[1]), '%,', !1)
                          .appendXtra('', p[2], se(d[2], p[2]), T ? '%,' : '%' + P, !1)
                      : a
                          .appendXtra(T ? 'rgba(' : 'rgb(', p[0], d[0] - p[0], ',', !0, !0)
                          .appendXtra('', p[1], d[1] - p[1], ',', !0)
                          .appendXtra('', p[2], d[2] - p[2], T ? ',' : P, !0),
                    T && ((p = 4 > p.length ? 1 : p[3]), a.appendXtra('', p, (4 > d.length ? 1 : d[3]) - p, P, !1))),
                (fe.lastIndex = 0);
            else if ((v = p.match(m))) {
      ...
      (h.xs0 = ''),
        ...
        (h.appendXtra = function (t, e, i, r, s, n) {
          var a = this,
            o = a.l;
          return (a['xs' + o] += n && o ? ' ' + t : t || ''), i || 0 === o || a.plugin ? (a.l++, (a.type = a.setRatio ? 2 : 1), (a['xs' + a.l] = r || ''), o > 0 ? ((a.data['xn' + o] = e + i), (a.rxp['xn' + o] = s), (a['xn' + o] = e), a.plugin || ((a.xfirst = new de(a, 'xn' + o, e, i, a.xfirst || a, 0, a.n, s, a.pr)), (a.xfirst.xs0 = 0)), a) : ((a.data = { s: e + i }), (a.rxp = {}), (a.s = e), (a.c = i), (a.r = s), a)) : ((a['xs' + o] += e + (r || '')), a);
        });
      var ye = function (t, e) {
      ...
      var we,
        ...
        De = (function () {
          ...
          return X.createElementNS && !r && ((t = Ae('svg', Me)), (e = Ae('rect', t, { width: 100, height: 50, x: 100 })), (i = e.getBoundingClientRect().width), (e.style[Oe] = '50% 50%'), (e.style[Pe] = 'scaleX(0.5)'), (r = i === e.getBoundingClientRect().width && !(_ && Ce)), Me.removeChild(t)), r;
        })(),
        Le = function (t, e, i, r, s) {
          ...
          x && ((v = x.xOrigin), (y = x.yOrigin)),
            (!r || 2 > (n = r.split(' ')).length) && ((c = t.getBBox()), (e = re(e).split(' ')), (n = [(-1 !== e[0].indexOf('%') ? (parseFloat(e[0]) / 100) * c.width : parseFloat(e[0])) + c.x, (-1 !== e[1].indexOf('%') ? (parseFloat(e[1]) / 100) * c.height : parseFloat(e[1])) + c.y])),
        ...
        Xe = function (t, e) {
          var i,
            ...
            l = 1e5;
          if (
            (Pe ? (r = Q(t, Se, null, !0)) : t.currentStyle && ((r = t.currentStyle.filter.match(A)), (r = r && 4 === r.length ? [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), o.x || 0, o.y || 0].join(',') : '')),
            (i = !r || 'none' === r || 'matrix(1, 0, 0, 1, 0, 0)' === r),
            (o.svg || (t.getBBox && Ne(t))) && (i && -1 !== (t.style[Pe] + '').indexOf('matrix') && ((r = t.style[Pe]), (i = 0)), (s = t.getAttribute('transform')), i && s && (-1 !== s.indexOf('matrix') ? ((r = s), (i = 0)) : -1 !== s.indexOf('translate') && ((r = 'matrix(1,0,0,1,' + s.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(',') + ')'), (i = 0)))),
            i)
          )
            return Fe;
          for (s = (r || '').match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], ve = s.length; --ve > -1; ) (n = Number(s[ve])), (s[ve] = (a = n - (n |= 0)) ? (0 | (a * l + (0 > a ? -0.5 : 0.5))) / l + n : n);
        ...
        Be = function (t) {
          ...
          if (c) {
            ...
            if (
              (null != r.ox && ((_ = (r.oxp ? 0.01 * m * r.ox : r.ox) - m / 2), (p = (r.oyp ? 0.01 * g * r.oy : r.oy) - g / 2), (w += _ - (_ * o + p * l)), (b += p - (_ * h + p * u))),
              v ? ((_ = m / 2), (p = g / 2), (y += ', Dx=' + (_ - (_ * o + p * l) + w) + ', Dy=' + (p - (_ * h + p * u) + b) + ')')) : (y += ", sizingMethod='auto expand')"),
                ...
                return (
                  C || S.skewX || z
                    ? ((C *= L),
                      ...
                      z && ((N += S.xOrigin - (S.xOrigin * e + S.yOrigin * i) + S.xOffset), (F += S.yOrigin - (S.xOrigin * s + S.yOrigin * n) + S.yOffset), we && (S.xPercent || S.yPercent) && ((d = this.t.getBBox()), (N += 0.01 * S.xPercent * d.width), (F += 0.01 * S.yPercent * d.height)), (d = 1e-6), d > N && N > -d && (N = 0), d > F && F > -d && (F = 0)),
                      (x = (0 | (e * P)) / P + ',' + (0 | (s * P)) / P + ',' + (0 | (i * P)) / P + ',' + (0 | (n * P)) / P + ',' + N + ',' + F + ')'),
                      z && we ? this.t.setAttribute('transform', 'matrix(' + x) : (O[Pe] = (S.xPercent || S.yPercent ? 'translate(' + S.xPercent + '%,' + S.yPercent + '%) matrix(' : 'matrix(') + x))
                    : (O[Pe] = (S.xPercent || S.yPercent ? 'translate(' + S.xPercent + '%,' + S.yPercent + '%) matrix(' : 'matrix(') + A + ',0,0,' + M + ',' + N + ',' + F + ')'),
                  void 0
                );
      ...
      (h = ke.prototype),
        ...
        xe('transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin', {
          parser: function (t, e, i, r, n, o, l) {
            ...
            var h,
              ...
              P = {},
              S = 'transformOrigin';
            if ((l.display ? ((c = Q(t, 'display')), (x.display = 'block'), (h = ze(t, s, !0, l.parseTransform)), (x.display = c)) : (h = ze(t, s, !0, l.parseTransform)), (r._transform = h), 'string' == typeof b.transform && Pe))
              (c = B.style), (c[Pe] = b.transform), (c.display = 'block'), (c.position = 'absolute'), X.body.appendChild(B), (u = ze(B, null, !1)), X.body.removeChild(B), u.perspective || (u.perspective = h.perspective), null != b.xPercent && (u.xPercent = ne(b.xPercent, h.xPercent)), null != b.yPercent && (u.yPercent = ne(b.yPercent, h.yPercent));
              ...
              if (((u = { scaleX: ne(null != b.scaleX ? b.scaleX : b.scale, h.scaleX), scaleY: ne(null != b.scaleY ? b.scaleY : b.scale, h.scaleY), scaleZ: ne(b.scaleZ, h.scaleZ), x: ne(b.x, h.x), y: ne(b.y, h.y), z: ne(b.z, h.z), xPercent: ne(b.xPercent, h.xPercent), yPercent: ne(b.yPercent, h.yPercent), perspective: ne(b.transformPerspective, h.perspective) }), (m = b.directionalRotation), null != m))
                if ('object' == typeof m) for (c in m) b[c] = m[c];
                else b.rotation = m;
        ...
        xe('boxShadow', { defaultValue: '0px 0px 0px 0px #999', prefix: !0, color: !0, multi: !0, keyword: 'inset' }),
        xe('borderRadius', {
          defaultValue: '0px',
        ...
        xe('backgroundSize', { defaultValue: '0 0', formatter: re }),
        ...
        xe('margin', { parser: _e('marginTop,marginRight,marginBottom,marginLeft') }),
        xe('padding', { parser: _e('paddingTop,paddingRight,paddingBottom,paddingLeft') }),
        xe('clip', {
        ...
        xe('textShadow', { defaultValue: '0px 0px 0px #999', color: !0, multi: !0 }),
        ...
        xe('borderWidth', { parser: _e('borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth') }),
      ...
      var Ve = function (t) {
        if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && 'isFromStart' !== this.data.data) {
          ...
          else for (e = this.e.split(' ').join('').split(','), r = e.length; --r > -1; ) (i = e[r]), l[i] && (l[i].parse === o ? (s = !0) : (i = 'transformOrigin' === i ? Oe : l[i].p)), Ye(a, i);
        ...
        (h.parse = function (t, e, i, n) {
          ...
          for (a in e)
            (_ = e[a]),
              (o = l[a]),
              o
                ? (i = o.parse(t, _, a, this, i, n, e))
                : ((c = Q(t, a, s) + ''),
                  (m = 'string' == typeof _),
                  'color' === a || 'fill' === a || 'stroke' === a || -1 !== a.indexOf('Color') || (m && P.test(_))
                    ? (m || ((_ = he(_)), (_ = (_.length > 3 ? 'rgba(' : 'rgb(') + _.join(',') + ')')), (i = ge(v, a, c, _, !0, 'transparent', i, 0, n)))
                    : !m || (-1 === _.indexOf(' ') && -1 === _.indexOf(','))
                      ? ((h = parseFloat(c)),
                        (p = h || 0 === h ? c.substr((h + '').length) : ''),
                        ('' === c || 'auto' === c) && ('width' === a || 'height' === a ? ((h = ie(t, a, s)), (p = 'px')) : 'left' === a || 'top' === a ? ((h = $(t, a, s)), (p = 'px')) : ((h = 'opacity' !== a ? 0 : 1), (p = ''))),
                        (g = m && '=' === _.charAt(1)),
                        g ? ((f = parseInt(_.charAt(0) + '1', 10)), (_ = _.substr(2)), (f *= parseFloat(_)), (d = _.replace(x, ''))) : ((f = parseFloat(_)), (d = m ? _.replace(x, '') : '')),
                        '' === d && (d = a in r ? r[a] : p),
                        (_ = f || 0 === f ? (g ? f + h : f) + d : e[a]),
                        p !== d && '' !== d && (f || 0 === f) && h && ((h = Z(t, a, h, p)), '%' === d ? ((h /= Z(t, a, 100, '%') / 100), e.strictUnits !== !0 && (c = h + '%')) : 'em' === d || 'rem' === d ? (h /= Z(t, a, 1, d)) : 'px' !== d && ((f = Z(t, a, f, d)), (d = 'px')), g && (f || 0 === f) && (_ = f + h + d)),
                        g && (f += h),
                        (!h && 0 !== h) || (!f && 0 !== f) ? (void 0 !== v[a] && (_ || ('NaN' != _ + '' && null != _)) ? ((i = new de(v, a, f || h || 0, 0, i, -1, a, !1, 0, c, _)), (i.xs0 = 'none' !== _ || ('display' !== a && -1 === a.indexOf('Style')) ? _ : c)) : j('invalid ' + a + ' tween value: ' + e[a])) : ((i = new de(v, a, h, f - h, i, 0, a, u !== !1 && ('px' === d || 'zIndex' === a), 0, c, _)), (i.xs0 = d)))
                      : (i = ge(v, a, c, _, !0, null, i, 0, n))),
      ...
      var Ge = function (t, e, i) {
        ...
        else for (r = t.childNodes, s = r.length; --s > -1; ) (n = r[s]), (a = n.type), n.style && (e.push(K(n)), i && i.push(n)), (1 !== a && 9 !== a && 11 !== a) || !n.childNodes.length || Ge(n, e, i);
      };
      return (
  ...
  var e = t.GreenSockGlobals || t,
    ...
    _ = function (t) {
      var e,
        ...
        n = t.length;
      for (e = 0; n > e; e++)
        if (((i = t[e]), h(i))) for (s = i.length, s = 0; i.length > s; s++) r.push(i[s]);
        else r.push(i);
      return r;
    },
    ...
    y = function (t, e, i, s, o) {
      ...
      if (A || L) for (d = 0; h > d; d++) (b = w[d]), (f = b.parentNode === t), (f || L || (M && !D)) && ((x = b.offsetTop), A && f && x !== z && 'BR' !== b.nodeName && ((_ = []), A.push(_), (z = x)), L && ((b._x = b.offsetLeft), (b._y = x), (b._w = b.offsetWidth), (b._h = b.offsetHeight)), A && ((D !== f && M) || (_.push(b), (b._x -= E)), f && d && (w[d - 1]._wordEnd = !0), 'BR' === b.nodeName && b.nextSibling && 'BR' === b.nextSibling.nodeName && A.push([])));
      for (d = 0; h > d; d++)
        (b = w[d]),
          (f = b.parentNode === t),
          'BR' !== b.nodeName
            ? (L && ((S = b.style), D || f || ((b._x += b.parentNode._x), (b._y += b.parentNode._y)), (S.left = b._x + 'px'), (S.top = b._y + 'px'), (S.position = 'absolute'), (S.display = 'block'), (S.width = b._w + 1 + 'px'), (S.height = b._h + 'px')), D ? (f && '' !== b.innerHTML ? J.push(b) : M && K.push(b)) : f ? (t.removeChild(b), w.splice(d--, 1), h--) : !f && M && ((x = !A && !L && b.nextSibling), t.appendChild(b), x || t.appendChild(n.createTextNode(' ')), K.push(b)))
            : A || L
              ? (t.removeChild(b), w.splice(d--, 1), h--)
              : D || t.appendChild(b);
      if (A) {
