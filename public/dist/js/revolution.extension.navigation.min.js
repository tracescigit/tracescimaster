...
!(function () {
  ...
  jQuery.extend(!0, t, {
    ...
    manageNavigation: function (e) {
      ...
      h(e.navigation.bullets) && ('fullscreen' != e.sliderLayout && 'fullwidth' != e.sliderLayout && ((e.navigation.bullets.h_offset_old = void 0 === e.navigation.bullets.h_offset_old ? e.navigation.bullets.h_offset : e.navigation.bullets.h_offset_old), (e.navigation.bullets.h_offset = 'center' === e.navigation.bullets.h_align ? e.navigation.bullets.h_offset_old + a / 2 - n / 2 : e.navigation.bullets.h_offset_old + a - n)), m(e.c.find('.tp-bullets'), e.navigation.bullets)),
  ...
  var i = function (t, e) {
      ...
      p > 2 && ((g = 0 >= c - (v + d) ? (0 - d > c - (v + d) ? v : g + d) : g), (g = d > c - d + v + l && c + (Math.round(p) - 2) * d < v ? c + (Math.round(p) - 2) * d : g)),
        ...
        t.hasClass('dragged') || ('vertical' === o ? s.data('tmmove', punchgs.TweenLite.to(s, 0.5, { top: g + 'px', ease: punchgs.Power3.easeInOut })) : s.data('tmmove', punchgs.TweenLite.to(s, 0.5, { left: g + 'px', ease: punchgs.Power3.easeInOut })), s.data('offset', g));
    },
      ...
      return (
        f &&
          jQuery.each(f, function (t, i) {
            'vertical' === a.direction ? e.add(punchgs.TweenLite.set(i, { top: t * (h + parseInt(void 0 === a.space ? 0 : a.space, 0)), width: l + 'px', height: h + 'px' })) : 'horizontal' === a.direction && e.add(punchgs.TweenLite.set(i, { left: t * (l + parseInt(void 0 === a.space ? 0 : a.space, 0)), width: l + 'px', height: h + 'px' }));
          }),
        e
      );
    },
      ...
      (d = 'swipebased' == n && 'vertical' == l ? 'none' : n ? 'vertical' : d),
        ...
        s.swipetp({
          ...
          swipeStatus: function (e, n, s, d) {
            ...
            if ('carousel' === a.sliderType && ((('move' === n || 'end' === n || 'cancel' == n) && a.dragStartedOverSlider && !a.dragStartedOverThumbs && !a.dragStartedOverTabs) || ('start' === n && h > 0 && 0 === p && 0 === u)))
              switch (((a.dragStartedOverSlider = !0), (d = s && s.match(/left|up/g) ? Math.round(-1 * d) : (d = Math.round(1 * d))), n)) {
                case 'start':
    ...
    m = function (t, e) {
      ...
      if ((g(t, e), v(t, e), 'outer-left' !== e.position || ('fullwidth' != e.sliderLayout && 'fullscreen' != e.sliderLayout) ? 'outer-right' !== e.position || ('fullwidth' != e.sliderLayout && 'fullscreen' != e.sliderLayout) || punchgs.TweenLite.set(t, { right: 0 - t.outerWidth() + 'px', x: e.h_offset + 'px' }) : punchgs.TweenLite.set(t, { left: 0 - t.outerWidth() + 'px', x: e.h_offset + 'px' }), t.hasClass('tp-thumbs') || t.hasClass('tp-tabs'))) {
        ...
        s > a && 'outer-left' !== e.position && 'outer-right' !== e.position ? (punchgs.TweenLite.set(t, { left: '0px', x: 0, maxWidth: a - 2 * r + 'px' }), punchgs.TweenLite.set(d, { maxWidth: a - 2 * r + 'px' })) : (punchgs.TweenLite.set(t, { maxWidth: s + 'px' }), punchgs.TweenLite.set(d, { maxWidth: s + 'px' })),
          o + 2 * r > n && 'outer-bottom' !== e.position && 'outer-top' !== e.position ? (punchgs.TweenLite.set(t, { top: '0px', y: 0, maxHeight: l + h + (n - 2 * r) + 'px' }), punchgs.TweenLite.set(d, { maxHeight: l + h + (n - 2 * r) + 'px' })) : (punchgs.TweenLite.set(t, { maxHeight: o + 'px' }), punchgs.TweenLite.set(d, { maxHeight: o + 'px' })),
          'outer-left' !== e.position && 'outer-right' !== e.position && ((l = 0), (h = 0)),
          e.span === !0 && 'vertical' === e.direction ? (punchgs.TweenLite.set(t, { maxHeight: l + h + (n - 2 * r) + 'px', height: l + h + (n - 2 * r) + 'px', top: 0 - l, y: 0 }), g(d, e)) : e.span === !0 && 'horizontal' === e.direction && (punchgs.TweenLite.set(t, { maxWidth: '100%', width: a - 2 * r + 'px', left: 0, x: 0 }), v(d, e));
      }
    },
    b = function (t, e, i, a) {
      ...
      'vertical' === e.direction ? (o.css({ top: (d - 1) * h + 'px', left: '0px' }), n.css({ height: (d - 1) * h + o.outerHeight(), width: o.outerWidth() })) : (o.css({ left: (d - 1) * l + 'px', top: '0px' }), n.css({ width: (d - 1) * l + o.outerWidth(), height: o.outerHeight() })),
