  ...
  var e = function (e, o, a, i) {
    ...
    o = function (t, e, o, a, i) {
      ...
      (e.duringslidechange = !0),
        (e.testanims = !1),
        1 == e.testanims && ((e.nexttesttransform = void 0 === e.nexttesttransform ? 34 : e.nexttesttransform + 1), (e.nexttesttransform = e.nexttesttransform > 70 ? 0 : e.nexttesttransform), (o = y[e.nexttesttransform][0]), console.log(o + '  ' + e.nexttesttransform + '  ' + y[e.nexttesttransform][1] + '  ' + y[e.nexttesttransform][2])),
    ...
    i = function (t, i, n, r, s, l, d, h, f) {
      ...
      if (4 == t || 5 == t) {
        ...
        h.find('.slotslide').each(function (e) {
          var o = jQuery(this),
            a = (e * k) / r.slots;
          5 == t && (a = ((r.slots - e - 1) * k) / r.slots / 1.5), j.add(punchgs.TweenLite.to(o, 3 * k, { transformPerspective: 600, force3D: 'auto', top: 0 + r.height, opacity: 0.5, rotation: r.rotate, ease: T, delay: a }), 0), f.add(j, 0);
        }),
      ...
      if (7 == t) {
        ...
        setTimeout(function () {
          ...
          d.find('.slotslide').each(function (t) {
            ...
            j.add(punchgs.TweenLite.fromTo(e, y / 1e3, { left: 0, top: 0, opacity: 0, transformPerspective: 600 }, { left: 0 - t * r.slotw + 'px', ease: z, force3D: 'auto', top: '0px', width: r.width, height: r.height, opacity: 1, rotation: 0, delay: 0.1 }), 0), f.add(j, 0);
          });
      }
      if (8 == t) {
      ...
      if (12 == t || 13 == t || 14 == t || 15 == t) {
        ...
        var F = r.width,
          ...
          oe = y / 1e3,
          ae = oe;
        ('fullwidth' == r.sliderLayout || 'fullscreen' == r.sliderLayout) && ((F = K.width()), (G = K.height())), 12 == t ? (U = F) : 15 == t ? (U = 0 - F) : 13 == t ? (W = G) : 14 == t && (W = 0 - G), 1 == m && ($ = 0), 2 == m && ($ = 0), 3 == m && (oe = y / 1300), (4 == m || 5 == m) && (te = 0.6), 6 == m && (te = 1.4), (5 == m || 6 == m) && ((ee = 1.4), ($ = 0), (F = 0), (G = 0), (U = 0), (W = 0)), 6 == m && (ee = 0.6);
        7 == m && ((F = 0), (G = 0));
        ...
        if (
          ...
          8 == m ? (f.add(punchgs.TweenLite.set(l, { zIndex: 20 }), 0), f.add(punchgs.TweenLite.set(s, { zIndex: 15 }), 0), f.add(punchgs.TweenLite.set(ie, { left: 0, top: 0, scale: 1, opacity: 1, rotation: 0, ease: T, force3D: 'auto' }), 0)) : f.add(punchgs.TweenLite.from(ie, oe, { left: U, top: W, scale: ee, opacity: $, rotation: r.rotate, ease: T, force3D: 'auto' }), 0),
          (4 == m || 5 == m) && ((F = 0), (G = 0)),
          1 != m)
        )
          switch (t) {
      ...
      if (16 == t) {
        ...
        'on' == r.autoHeight && (G = n.height()),
          ...
          f.add(punchgs.TweenLite.set(l.find('.tp-half-two'), { width: F, height: G, overflow: 'hidden', zIndex: 15, position: 'absolute', top: G / 2, left: '0px', transformPerspective: 600, transformOrigin: 'center bottom' }), 0),
          f.add(punchgs.TweenLite.set(l.find('.tp-half-one'), { width: F, height: G / 2, overflow: 'visible', zIndex: 10, position: 'absolute', top: '0px', left: '0px', transformPerspective: 600, transformOrigin: 'center top' }), 0);
        ...
        f.add(punchgs.TweenLite.set(l.find('.tp-half-one'), { overflow: 'hidden' }), 0),
          f.add(punchgs.TweenLite.fromTo(l.find('.tp-half-one'), y / 800, { width: F, height: G / 2, position: 'absolute', top: '0px', left: '0px', force3D: 'auto', transformOrigin: 'center top' }, { scale: fe, rotation: re, y: 0 - G - G / 4, autoAlpha: 0, ease: T }), 0),
          f.add(
          ...
          null != l.html() && f.add(punchgs.TweenLite.fromTo(s, (y - 200) / 1e3, { scale: pe, x: (r.width / 4) * de, y: (G / 4) * he, rotation: le, force3D: 'auto', transformOrigin: 'center center', ease: z }, { autoAlpha: 1, scale: 1, x: 0, y: 0, rotation: 0 }), 0),
          f.add(j, 0);
      }
      if (
        (17 == t &&
          d.find('.slotslide').each(function (t) {
            var e = jQuery(this);
            f.add(punchgs.TweenLite.fromTo(e, y / 800, { opacity: 0, rotationY: 0, scale: 0.9, rotationX: -110, force3D: 'auto', transformPerspective: 600, transformOrigin: 'center center' }, { opacity: 1, top: 0, left: 0, scale: 1, rotation: 0, rotationX: 0, force3D: 'auto', rotationY: 0, ease: T, delay: 0.06 * t }), 0);
          }),
        18 == t &&
          d.find('.slotslide').each(function (t) {
            var e = jQuery(this);
            f.add(punchgs.TweenLite.fromTo(e, y / 500, { autoAlpha: 0, rotationY: 110, scale: 0.9, rotationX: 10, force3D: 'auto', transformPerspective: 600, transformOrigin: 'center center' }, { autoAlpha: 1, top: 0, left: 0, scale: 1, rotation: 0, rotationX: 0, force3D: 'auto', rotationY: 0, ease: T, delay: 0.06 * t }), 0);
          }),
        19 == t || 22 == t)
      ) {
        var j = new punchgs.TimelineLite();
      ...
      if (21 == t || 25 == t) {
        ...
        d.find('.slotslide').each(function () {
          ...
          1 != g ? ((we = -r.width), (ue = 90), 25 == t ? ((ge = 'center top 0'), (ve = -ue), (ue = r.rotate)) : ((ge = 'left center 0'), (ve = r.rotate))) : ((we = r.width), (ue = -90), 25 == t ? ((ge = 'center bottom 0'), (ve = -ue), (ue = r.rotate)) : ((ge = 'right center 0'), (ve = r.rotate))),
          h.find('.slotslide').each(function () {
            var t = jQuery(this);
