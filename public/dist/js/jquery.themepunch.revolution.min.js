...
!(function (e, t) {
  ...
  e.fn.extend({
    revolution: function (a) {
      var n = {
        ...
        parallax: { type: 'off', levels: [10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75, 80, 85], origo: 'enterpoint', speed: 400, bgparallax: 'on', opacity: 'on', disable_onmobile: 'off', ddd_shadow: 'on', ddd_bgfreeze: 'off', ddd_overflow: 'visible', ddd_layer_overflow: 'visible', ddd_z_correction: 65, ddd_path: 'mouse' },
    ...
    revscroll: function (i) {
      return this.each(function () {
        var a = e(this);
        a != t && a.length > 0 && e('body').find('#' + a.attr('id')).length > 0 && e('body,html').animate({ scrollTop: a.offset().top + a.height() - i + 'px' }, { duration: 400 });
      });
    },
    ...
    callingNewSlide: function (t, i, a) {
      ...
      i.find('.next-revslide').removeClass('next-revslide'),
        (a && e.isNumeric(a)) || a.match(/to/g)
          ? (1 === a || -1 === a ? ((o = n + a), (o = 0 > o ? t.slideamount - 1 : o >= t.slideamount ? 0 : o)) : ((a = e.isNumeric(a) ? a : parseInt(a.split('to')[1], 0)), (o = 0 > a ? 0 : a > t.slideamount - 1 ? t.slideamount - 1 : a)), i.find('.tp-revslider-slidesli:eq(' + o + ')').addClass('next-revslide'))
          : a &&
  ...
  var a = i.is_mobile(),
      ...
      return (
        ...
        o.data('version') && o.data('version').toString().match(/5./gi)
          ? (o.find('img').each(function () {
            ...
            ('carousel' == a.sliderType || 'on' == s.keyboardNavigation || 'on' == s.mouseScrollNavigation || 'on' == s.touch.touchenabled || s.arrows.enable || s.bullets.enable || s.thumbnails.enable || s.tabs.enable) && (r.navigation = !0),
    ...
    u = function (n, o) {
      ...
      if (
          ...
          n.find('.tp-caption, .rs-background-video-layer').each(function (n) {
            ...
            if (
              (r.find('iframe').each(function () {
                punchgs.TweenLite.set(e(this), { autoAlpha: 0 }), c++;
              }),
              c > 0 && r.data('iframes', !0),
              r.hasClass('tp-caption'))
            ) {
        ...
        e(window).on(I, function () {
          ...
          g(n, o),
          f(o),
          o.fallbacks.disableFocusListener || 'true' == o.fallbacks.disableFocusListener || o.fallbacks.disableFocusListener === !0 || M(n, o);
      }
    },
    p = function (t, i) {
      if (!e.isArray(t)) {
    ...
    f = function (t) {
      ...
      if ('auto' == t.sliderLayout || ('fullscreen' === t.sliderLayout && 'on' == t.fullScreenAutoWidth)) 'fullscreen' == t.sliderLayout && 'on' == t.fullScreenAutoWidth ? punchgs.TweenLite.set(t.ul, { left: 0, width: t.c.width() }) : punchgs.TweenLite.set(t.ul, { left: a, width: t.c.width() - i.getHorizontalOffset(t.c, 'both') });
      else {
    ...
    g = function (a, n, o) {
      ...
      e(window).width() < n.hideSliderAtLimit
        ...
        : a.is(':hidden') &&
          o &&
          (r.data('olddisplay') != t && 'undefined' != r.data('olddisplay') && 'none' != r.data('olddisplay') ? r.css({ display: r.data('olddisplay') }) : r.css({ display: 'block' }),
    ...
    v = function (a, n) {
      if ((1 == n.infullscreenmode && (n.minHeight = e(window).height()), l(n), l(n, !0), !i.resizeThumbsTabs || i.resizeThumbsTabs(n) === !0)) {
        ...
        b(a, n, a, 2),
          'standard' === n.sliderType && (punchgs.TweenLite.set(r.find('.defaultimg'), { opacity: 0 }), o.find('.defaultimg').css({ opacity: 1 })),
    ...
    y = function (n, o) {
      ...
      n.parent().css({ overflow: 'visible' }),
        o.li.find('>img').each(function (i) {
          ...
          r.addClass('defaultvid').css({ zIndex: 30 }), n.addClass('defaultimg'), 'on' == o.panZoomDisableOnMobile && a && (n.data('kenburns', 'off'), n.data('bgfit', 'cover')), n.wrap('<div class="slotholder" style="width:100%;height:100%;"></div>'), r.appendTo(n.closest('li').find('.slotholder'));
          var s = n.data();
        ...
        i.loadqueue &&
          e.each(i.loadqueue, function (e, i) {
            ...
            (o = o.substring(0, o.length - 1) + n),
              (r += n),
              (w(r) === w(decodeURIComponent(t.src)) || w(o) === w(decodeURIComponent(t.src)) || w(d) === w(decodeURIComponent(t.src)) || w(l) === w(decodeURIComponent(t.src)) || w(s) === w(decodeURIComponent(t.src)) || w(i.src) === w(decodeURIComponent(t.src)) || w(i.src).replace(/^.*\/\/[^\/]+/, '') === w(decodeURIComponent(t.src)).replace(/^.*\/\/[^\/]+/, '') || ('file://' === window.location.origin && w(t.src).match(new RegExp(n)))) &&
    ...
    A = function (t, a) {
      ...
      return o.index() === n.index()
        ...
        : (o.removeClass('next-revslide').addClass('processing-revslide'),
          ...
          t.trigger('stoptimer'),
          (a.cd = 0),
          'off' === a.spinner ? t.find('.tp-loader').css({ display: 'none' }) : t.find('.tp-loader').css({ display: 'block' }),
          L(o, a, 1),
          void S(o, a, function () {
    ...
    H = function (n, o, r, s, l, d, c) {
      'carousel' === o.sliderType ||
        ...
        d.find('.rs-background-video-layer').each(function (t) {
          if (a) return !1;
          var n = e(this);
          i.stopVideo && (i.resetVideo(n, o), i.stopVideo(n, o)), punchgs.TweenLite.to(n, 1, { autoAlpha: 0, ease: punchgs.Power3.easeInOut, delay: 0.2 });
        });
      var u = {};
    ...
    P = function (n, o) {
      ...
      n.on('stoptimer', function () {
        ...
        t.data('tween').pause(), 'on' == o.disableProgressBar && t.css({ visibility: 'hidden' }), (o.sliderstatus = 'paused'), i.unToggleState(o.slidertoggledby);
      }),
        n.on('starttimer', function () {
          1 != o.conthover && 1 != o.videoplaying && o.width > o.hideSliderAtLimit && 1 != o.tonpause && 1 != o.overnav && (1 === o.noloopanymore || (o.viewPort.enable && !o.inviewport) || (r.css({ visibility: 'visible' }), r.data('tween').resume(), (o.sliderstatus = 'playing'))), 'on' == o.disableProgressBar && r.css({ visibility: 'hidden' }), i.toggleState(o.slidertoggledby);
        }),
        n.on('restarttimer', function () {
          var t = e(this).find('.tp-bannertimer');
          return o.mouseoncontainer && 'on' == o.navigation.onHoverStop && !a
            ? !1
            : (1 === o.noloopanymore || (o.viewPort.enable && !o.inviewport) || (t.css({ visibility: 'visible' }), t.data('tween').kill(), t.data('tween', punchgs.TweenLite.fromTo(t, o.delay / 1e3, { width: '0%' }, { force3D: 'auto', width: '100%', ease: punchgs.Linear.easeNone, onComplete: s, delay: 1 })), (o.sliderstatus = 'playing')), 'on' == o.disableProgressBar && t.css({ visibility: 'hidden' }), void i.toggleState(o.slidertoggledby));
        }),
