  ...
  var checkActions_intern = function (e, t, a) {
      a &&
        jQuery.each(a, function (a, o) {
          (o.delay = parseInt(o.delay, 0) / 1e3),
            e.addClass('noSwipe'),
            t.fullscreen_esclistener ||
              (('exitfullscreen' == o.action || 'togglefullscreen' == o.action) &&
                (jQuery(document).keyup(function (t) {
                  27 == t.keyCode && jQuery('#rs-go-fullscreen').length > 0 && e.trigger(o.event);
                }),
                (t.fullscreen_esclistener = !0)));
          var l = 'backgroundvideo' == o.layer ? jQuery('.rs-background-video-layer') : 'firstvideo' == o.layer ? jQuery('.tp-revslider-slidesli').find('.tp-videolayer') : jQuery('#' + o.layer);
          switch (o.action) {
            case 'togglevideo':
              jQuery.each(l, function (t, a) {
                a = jQuery(a);
                var o = a.data('videotoggledby');
                void 0 == o && (o = new Array()), o.push(e), a.data('videotoggledby', o);
              });
              break;
            case 'togglelayer':
              jQuery.each(l, function (t, a) {
                ...
                void 0 == o && (o = new Array()), o.push(e), a.data('layertoggledby', o);
              });
              break;
            case 'toggle_mute_video':
              jQuery.each(l, function (t, a) {
                a = jQuery(a);
                var o = a.data('videomutetoggledby');
                void 0 == o && (o = new Array()), o.push(e), a.data('videomutetoggledby', o);
              });
              break;
            case 'toggleslider':
          ...
          switch (
            (e.on(o.event, function () {
              var a = 'backgroundvideo' == o.layer ? jQuery('.active-revslide .slotholder .rs-background-video-layer') : 'firstvideo' == o.layer ? jQuery('.active-revslide .tp-videolayer').first() : jQuery('#' + o.layer);
              if ('stoplayer' == o.action || 'togglelayer' == o.action || 'startlayer' == o.action) {
                if (a.length > 0)
                  if ('startlayer' == o.action || ('togglelayer' == o.action && 'in' != a.data('animdirection'))) {
                    a.data('animdirection', 'in');
                    var l = a.data('timeline_out'),
                      r = 'carousel' === t.sliderType ? 0 : t.width / 2 - (t.gridwidth[t.curWinRange] * t.bw) / 2,
                      i = 0;
                    void 0 != l && l.pause(0).kill(), _R.animateSingleCaption && _R.animateSingleCaption(a, t, r, i, 0, !1, !0);
                    var n = a.data('timeline');
                    a.data('triggerstate', 'on'),
                      _R.toggleState(a.data('layertoggledby')),
                  ...
                  } else ('stoplayer' == o.action || ('togglelayer' == o.action && 'out' != a.data('animdirection'))) && (a.data('animdirection', 'out'), a.data('triggered', !0), a.data('triggerstate', 'off'), _R.stopVideo && _R.stopVideo(a, t), _R.endMoveCaption && punchgs.TweenLite.delayedCall(o.delay, _R.endMoveCaption, [a, null, null, t]), _R.unToggleState(a.data('layertoggledby')));
              } else
                !_ISM || ('playvideo' != o.action && 'stopvideo' != o.action && 'togglevideo' != o.action && 'mutevideo' != o.action && 'unmutevideo' != o.action && 'toggle_mute_video' != o.action)
                  ? punchgs.TweenLite.delayedCall(
                      o.delay,
                      function () {
                        actionSwitches(a, t, o, e);
                      },
                      [a, t, o, e]
                    )
                  : actionSwitches(a, t, o, e);
