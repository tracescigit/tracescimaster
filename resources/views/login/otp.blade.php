    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                <h2 class="intro-x px-2 font-bold text-2xl xl:text-3xl text-center xl:text-left">Verify Otp</h2>
                    ...
                    <form id="register-form">
                        ...
                        <div class="grid grid-cols-12">
                            ...
                            <div class="input-form col-span-12 px-2 mt-2">
                                <input id="otp" name="otp" type="text" class="form-control form__input" placeholder="Enter otp" value="">
                                <div id="error-otp" class="login__input-error w-100 text-theme-6 mt-1 mb-2"></div>
                            </div>
                ...
                <div class="intro-x mt-3 xl:mt-4 text-center xl:text-left px-2">
                    <button id="btn-signup" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Verify otp</button>
                </div>
