		...
		<div class="mt-2 mb-4">
			...
			<div class="mt-2 mb-4">
				...
				<div class="px-6 pb-6 mx-3"> 
					...
					<ul class="text-gray-600">
						...
						<li class="list-style-bullet px-6 p-3">
						How you came to the Website (previous page, hyperlink etc.)</li>
						<li class="list-style-bullet px-6 p-3">
						Quel navigateur (et version) vous utilisez</li>
						<li class="list-style-bullet px-6 p-3">
						The operating system you use</li>
						<li class="list-style-bullet px-6 p-3">
						Which Internet service provider you use</li>
						<li class="list-style-bullet px-6 p-3">
						Your IP address, which is assigned to your computer by your Internet service provider for when you connect to the Internet</li>
					</ul>
				</div>
				<p class="text-gray-600 p-2">
					...
					The legalbasis for temporary storage of the data and logfiles is GDPR.
			...
			<div class="mt-2 mb-4">
				...
				<div class="px-6 pb-6 mx-3"> 
					...
					<ul class="text-gray-600">
						<li class="list-style-bullet px-6 p-3">
						If you transmit your personal data to us via our Website or in an email, it will only be used for the purpose stated before.</li>
						<li class="list-style-bullet px-6 p-3">
						Our employees are bound individually to observe a duty to confidentiality and are obliged to observe the principles of data secrecy.</li>
						<li class="list-style-bullet px-6 p-3">
						Our security measures reflect the current state-of-the-art as far as reasonably possible.</li>
						<li class="list-style-bullet px-6 p-3">
						The security of our systems is checked regularly, so that we can permanently protect the data entrusted to us from any damage, loss or access.</li>
						<li class="list-style-bullet px-6 p-3">
						The data protection officer works continuously to ensure that the provisions of the law are maintained.</li>
					</ul>
				</div>
			</div>
			<div class="mt-2 mb-4">
				...
				<p class="text-gray-600 p-2">
					You can configure your browser so that you are informed as soon as cookies are to be set, so that you can accept them globally or on a case by case basis, or reject them globally 
