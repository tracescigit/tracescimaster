...
<html lang="en">
  <head>
    ...
    <!-- GOOGLE FONT -->
    <link href="../css?family=Lora:400,400italic,700,700italic" rel="stylesheet" type="text/css">
    <link href="../css-1?family=Raleway:400,100,200,300,500,600,700,800,900" rel="stylesheet" type="text/css">
    <link href="../css-2?family=Droid+Serif:400,400italic,700,700italic" rel="stylesheet" type="text/css">
    <link href="../css-3?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic" rel="stylesheet" type="text/css">
        ...
        <div class="right_menu_item-content">
          ...
          <div class="right-menu-list">
            <ul>
              ...
              <li><a href="feature-typography.html">Features</a></li>
              <li><a href="plans.html">Plans</a></li>
              <li class="active"><a href="blog-standard-right-sidebar.html">Blog</a></li>
          ...
          <div class="right-menu-social-box">
            ...
            <div class="footer-bottom-right right-menu-copyright">
              ...
              <p>
                With Love by <span><a href="#">7oroof.com</a></span>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container custom-header">
        <div class="row">
          <div id="menuzord" class="menuzord">
            <a href="home.html" class="menuzord-brand"><img src="images/logo.png" alt="">metrics</a>
            ...
            <ul class="menuzord-menu menuzord-menu-bg">
              ...
              <li>
                ...
                <ul class="dropdown">
                  <li>
                    ...
                    <ul class="dropdown">
                      <li>
                        <a href="header-1.html">Header Basic</a>
                        <ul class="dropdown">
                      ...
                      <li>
                        <a href="header-10.html">Header Transparent</a>
                        <ul class="dropdown">
                  ...
                  <li>
                    <a href="page-title-1.html">Page titles</a>
                    <ul class="dropdown">
                      ...
                      <li><a href="page-title-11.html">Page Title 11</a></li>
                    </ul>
                  </li>
                  <li>
                    <a href="footer-1.html">Footers</a>
                    <ul class="dropdown">
                  ...
                  <li>
                    ...
                    <ul class="dropdown">
                      <li><a href="gallery-2.html">Gallery 2 Cols</a></li>
                      <li><a href="gallery.html">Gallery 3 Cols</a></li>
                      <li><a href="gallery-4.html">Gallery 4 Cols</a></li>
                    </ul>
                  </li>
              ...
              <li><a href="products.html">Products</a></li>
              <li>
                <a href="solution-1.html">Solutions</a>
                <ul class="dropdown">
                  <li><a href="solution-1.html">Our Solution 1</a></li>
                  <li><a href="solution-2.html">Our Solution 2</a></li>
                  <li><a href="solution-blocks.html">Solution Block</a></li>
                  <li><a href="case-studies.html">Case Studies</a></li>
                  <li><a href="case-study-single.html">Single Case Studies</a></li>
                </ul>
              </li>
              <li>
                <a href="feature-typography.html">Features</a>
                <div class="megamenu megamenu-full-width megamenu-bg">
                  <div class="megamenu-row">
                    <div class="mega-item col3">
                      <ul>
                        <li><a href="feature-404.html">404 Page</a></li>
                        <li><a href="feature-coming-soon.html">Coming Soon Page</a></li>
                        <li><a href="feature-maintenance.html">Maintenance</a></li>
                      </ul>
                    </div>
                    <div class="mega-item col3">
                      <ul>
                        ...
                        <li><a href="testimonial-block.html">testimonial block</a></li>
                      </ul>
                    </div>
                    <div class="mega-item col3">
                      <ul>
                        <li><a href="accordion.html">Accordions</a></li>
                        <li><a href="feature-pricing-table.html">Pricing Tables</a></li>
                        <li><a href="faqs.html">Faqs</a></li>
                      </ul>
                    </div>
                    <div class="mega-item col3">
                      <ul>
                        ...
                        <li><a href="feature-section.html">Section</a></li>
                        <li><a href="feature-sortcodes.html">Sortcode</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <li><a href="plans.html">Plans</a></li>
              <li class="active">
                <a href="blog-standard-right-sidebar.html">BLOG</a>
                <ul class="dropdown blog-dropdown">
                  <li>
                    <a href="blog-2-column.html">Blog Grid</a>
                    <ul class="dropdown">
                  ...
                  <li>
                    <a href="blog-minimal-2-column-full-width.html">Blog Minimal</a>
                    <ul class="dropdown">
                  ...
                  <li>
                    <a href="blog-single-post-right-sidebar.html">Single Post</a>
                    <ul class="dropdown">
              ...
              <li>
                <a href="shop-category-right-sidebar.html">Shop</a>
                <ul class="dropdown">
                  ...
                  <li><a href="shop-single-product-right-sidebar.html">single right sidebar</a></li>
                  <li><a href="shop-single-product-left-sidebar.html">single left sidebar</a></li>
                  <li><a href="shop-single-product-full-width.html">single full width</a></li>
          ...
          <div class="col-md-12 no-padding text-left">
            <div class="blog-2-column-left-content">
              <div class="col-sm-6 col-md-6">
                <div class="blog-2-column-content">
                  <div class="full-intro-img">
                    <img src="images/single-blog-1.png" alt="" class="img-responsive">
                  </div>
                  ...
                  <div class="full-intro-content">
                    ...
                    <p>
                      <img src="images/blog/blog-user-1.png" alt="">By:<span><a href="#"> Ahmed Ebraheem</a></span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-6">
                <div class="blog-2-column-content">
                  <div class="full-intro-img">
                    <img src="images/single-blog-2.png" alt="" class="img-responsive">
                  </div>
                  <div class="full-intro-head">
                    <p>
                  ...
                  <div class="full-intro-content">
                    ...
                    <p>
                      <img src="images/blog/blog-user-2.png" alt="">By:<span><a href="#"> Ahmed Ali</a></span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-6">
                <div class="blog-2-column-content">
                  <div class="full-intro-img">
                    <img src="images/single-blog-3.png" alt="" class="img-responsive">
                  </div>
                  <div class="full-intro-head">
                    <p>
                      Oct 15, 2015 . <span><a href="#">Tools, News</a></span>. Comments : <span><a href="#">70</a></span>
              ...
              <div class="col-sm-6 col-md-6">
                <div class="blog-2-column-content">
                  ...
                  <div class="full-intro-content">
                    ...
                    <p>
                      <img src="images/blog/blog-user-3.png" alt="">By:<span><a href="#"> Ahmed Ebraheem</a></span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-6">
                <div class="blog-2-column-content">
                  <div class="full-intro-img">
                    <img src="images/single-blog-4.png" alt="" class="img-responsive">
                  </div>
                  <div class="full-intro-head">
                    <p>
                      Oct 30, 2015 . <span><a href="#">Tools, Videos</a></span>. Comments : <span><a href="#">70</a></span>
              ...
              <div class="col-sm-6 col-md-6">
                <div class="blog-2-column-content">
                  <div class="full-intro-img">
                    <img src="images/single-blog-5.png" alt="" class="img-responsive">
                  </div>
                  <div class="full-intro-head">
                    <p>
                      Oct 30, 2015 . <span><a href="#">Tools, Videos</a></span>. Comments : <span><a href="#">70</a></span>
                  ...
                  <div class="full-intro-content">
                    <p>We all know that no user is the same. Aside from the basics such as age, gender, socio-economic background and so every person differs in life experiences, interests, and preferences.</p>
                    <p>
                      <img src="images/blog/blog-user-3.png" alt="">By:<span><a href="#"> Ahmed Emad</a></span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="footer-bottom-content clearfix">
                <div class="col-sm-6 col-md-6 no-padding-left">
                  <div class="footer-bottom-left"><span>Terms & Conditions </span> | <span> API Use Policy | </span> <span>Privacy Policy | </span> <span>Cookies</span></div>
                </div>
                <div class="col-sm-6 col-md-6 no-padding-right">
                  <div class="footer-bottom-right">
                    <p>© 2015 - 2016 Metrics. All Rights Reserved</p>
                    <p>
                      With Love by <span><a href="http://themeforest.net/user/7oroof/portfolio?ref=7oroof" target="_blank">7oroof.com</a></span>
                    </p>
                  </div>
                </div>
              </div>
