...
@section('subhead')
<title>Edit Event | TRACESCI Admin</title>
<meta name="description" content="Edit and Update an Event in TRACESCI.">
<meta name="robots" content="noindex, nofollow">
<meta property="og:title" content="Edit Event | TRACESCI Admin">
<meta property="og:description" content="Edit and Update an Event on TRACESCI.">
<meta property="og:type" content="website">
<link rel="canonical" href="{{ url('/admin/Events/' . $event->id . '/edit') }}">
...
<header class="intro-y mt-8">
    <div class="page-header-bar">
        <div>
            <h1 class="text-lg font-medium" style="font-size:1.2rem;">Edit Event</h1>
            <nav class="breadcrumb-nav" aria-label="Breadcrumb">
                ...
                <span>Edit: {{ $event->event_name }}</span>
            </nav>
        </div>
...
<main class="grid grid-cols-12 gap-6 mt-5" id="main-content" aria-label="Edit Event Form">
    <div class="intro-y col-span-12 lg:col-span-12">
        <form id="edit-form" enctype="multipart/form-data" novalidate aria-label="Edit event form">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-12">
                        ...
                        <div class="input-form col-span-12 lg:col-span-6 px-2 py-1 mt-1">
                            ...
                            <textarea
                                ...
                                aria-required="true"
                                aria-describedby="error-address hint-address">{{ old('address', $event->address) }}</textarea>
                        ...
                        <div class="input-form col-span-12 lg:col-span-6 px-2 py-1 mt-1">
                            ...
                            <input
                                ...
                                autocomplete="off"
                                aria-required="true"
                                aria-describedby="error-city hint-city">
                        ...
                        <div class="input-form col-span-12 lg:col-span-6 px-2 py-1 mt-1">
                            ...
                            <p id="hint-event_img" class="input-hint">Upload a new image to replace the current one (JPG, PNG, JPEG). Max size: 2MB. Leave blank to keep existing.</p>
                            ...
                            <div class="current-image-preview">
                                <img
                                    ...
                                    alt="Current event cover image"
                                    id="current-img-thumb">
                                <div class="current-image-label">
                                    Current image &mdash;
                                    <a href="{{ asset('storage/' . $event->image_path) }}" target="_blank" rel="noopener noreferrer">View full size</a>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="input-form col-span-12 lg:col-span-6 px-2 py-1 mt-1">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input
                                    ...
                                    name="allowed"
                                    value="1"
                                    {{ old('1', $event->is_allowed) ? 'checked' : '' }}>
                        ...
                        <div class="input-form col-span-12 lg:col-span-6 px-2 py-1 mt-1">
                            <label for="status" class="form-label">
                                ...
                                <span
                                    id="status-badge"
                                    class="status-preview {{ old('status', $event->status) == 1 ? 'active' : 'inactive' }}"
                                    aria-live="polite">
                                    {{ old('status', $event->status) == 1 ? 'Active' : 'InActive' }}
                                </span>
                            </label>
                            <select
                                id="status"
                        ...
                        <div class="input-form col-span-12 lg:col-span-12 px-2 py-1 mt-2">
                            ...
                            <textarea
                                ...
                                minlength="2"
                                aria-describedby="error-description hint-description">{{ old('description', $event->description) }}</textarea>
                        ...
                        <div class="input-form col-span-12 lg:col-span-12 px-2 py-1 mt-5 flex flex-wrap gap-3 items-center">
                            <button type="submit" id="btn-update" class="btn btn-primary" aria-label="Save event changes">
                                Update Event
                            </button>
...
<script>
    cash(function() {
        ...
        cash('#event_img').on('change', function() {
        ...
        async function update() {
            ...
            axios.post("{{ route('admin-events-update', encrypt($event->id)) }}", formData)
                .then(res => {
                ...
                .catch(err => {
                    ...
                    cash('#btn-update').html(
                        '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Update Event'
                    );
