...
@section('subhead')
<title>{{__('user.update_user')}} TRACESCI</title>
@endsection
...
<div class="grid grid-cols-12 gap-6 mt-5">
	<div class="intro-y col-span-12 lg:col-span-12">
		<form id="update-form">
				...
				<div class="p-5">
					...
					<div class="grid grid-cols-12">
						...
						<div class="input-form col-span-12 lg:col-span-6 px-2 py-1">
							...
							<input id="full_name" type="text" name="full_name" value="{{$user->name}}" class="form-control form__input" placeholder="{{__('common.enter')}} {{__('common.full_name')}}" minlength="2">
			...
			@if (hasRoutePermission('admin-update-users',Auth::id()))
...
<script>
	cash(function () {
		async function add() {
			...
			axios.post('{{ url('/admin/users/'.encrypt($user->id).'/edit') }}', formData).then(res => {
