...
@section('subhead')
<title>{{__('alert.alerts')}} - TRACESCI</title>
@endsection
@section('subcontent')
	...
	<div class="col-span-12 lg:col-span-3 intro-y">
		<div class="report-box zoom-in">
			<div class="box p-5">
				...
				<div class="text-base text-gray-600 mt-1">{{__('alert.total_alerts')}}</div>
			</div>
		</div>
	</div>
	<div class="col-span-12 lg:col-span-3 intro-y">
		<div class="report-box zoom-in">
			<div class="box p-5">
				...
				<div class="text-3xl font-bold leading-8 mt-6">{{getActiveAlerts()}}</div>
				<div class="text-base text-gray-600 mt-1">{{__('alert.to_act')}}</div>
			</div>
		</div>
	</div>
</div>
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">{{__('alert.alerts')}}</h2>
</div>
