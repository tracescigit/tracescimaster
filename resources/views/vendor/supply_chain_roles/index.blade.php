...
@section('subhead')
<title>Supply Chain Roles - TRACESCI</title>
@endsection

@section('subcontent')
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">Supply Chain Roles</h2>
	<div class="w-full sm:w-auto flex mt-4 sm:mt-0">
		<a href="{{ route('vendor-create-supply-chain-roles') }}" class="btn btn-primary shadow-md mr-2">Add New Role</a>
		<div class="dropdown ml-auto sm:ml-0">
			<a href="{{ route('vendor-create-supply-chain-roles') }}" class="btn px-2 box text-gray-700 dark:text-gray-300" aria-expanded="false">
		...
		<form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto" >
			<div class="sm:flex items-center sm:mr-4">
				...
				<select id="tabulator-html-filter-field" class="form-select w-full sm:w-32 xxl:w-full mt-2 sm:mt-0 sm:w-auto">
					<option value="supply_chain_roles.name">Role Name</option>
				</select>
			</div>
...
<script>
	var tabulatorUrl =  '{{ route('vendor-supply-chain-roles') }}';
