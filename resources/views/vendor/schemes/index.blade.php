...
@section('subhead')
<title>Schemes - TRACESCI</title>
@endsection

@section('subcontent')
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">Schemes</h2>
	<div class="w-full sm:w-auto flex mt-4 sm:mt-0">
		<a href="{{ route('vendor-create-schemes') }}" class="btn btn-primary shadow-md mr-2">Add New Scheme</a>
		<div class="dropdown ml-auto sm:ml-0">
			<a href="{{ route('vendor-create-schemes') }}" class="btn px-2 box text-gray-700 dark:text-gray-300" aria-expanded="false">
