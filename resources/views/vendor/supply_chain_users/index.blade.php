...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">{{__('Supply Chain Users')}}</h2>
	@if (hasRoutePermission('vendor-create-supply-chain-users',Auth::id()))
	<div class="w-full sm:w-auto flex mt-4 sm:mt-0">
		<a href="{{ route('vendor-create-supply-chain-users') }}" class="btn btn-primary shadow-md mr-2">{{__('common.add_user')}}</a>
		<div class="dropdown ml-auto sm:ml-0">
			<a href="{{ route('vendor-create-supply-chain-users') }}" class="btn px-2 box text-gray-700 dark:text-gray-300" aria-expanded="false">
...
<script>
	var tabulatorUrl =  '{{ route('vendor-supply-chain-users') }}';
