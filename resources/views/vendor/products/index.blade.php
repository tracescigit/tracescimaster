...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
	...
	<div class="w-full sm:w-auto flex mt-4 sm:mt-0">
		<a href="{{ route('vendor-create-products') }}" class="btn btn-primary shadow-md mr-2">Add New Product</a>
		<div class="dropdown ml-auto sm:ml-0">
			<a href="{{ route('vendor-create-products') }}" class="btn px-2 box text-gray-700 dark:text-gray-300" aria-expanded="false">
