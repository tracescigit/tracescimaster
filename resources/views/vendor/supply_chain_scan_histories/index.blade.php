...
@section('subhead')
<title>Supply Chain Scan History - TRACESCI</title>
@endsection
@section('subcontent')
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">Supply Chain Scan History</h2>
</div>
		...
		<form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto" >
			<div class="sm:flex items-center sm:mr-4">
				...
				<select id="tabulator-html-filter-field" class="form-select w-full sm:w-32 xxl:w-full mt-2 sm:mt-0 sm:w-auto">
					...
					<option value="scanned_by">Scanned by</option>
...
<script>
	var tabulatorUrl =  '{{ route('vendor-supply-chain-scan-history') }}';
	...
	},
	{
		...
		download: true,
		formatter: function formatter(cell, formatterParams) {
			return "<div>\n                            <div class=\"font-medium whitespace-nowrap\">".concat(cell.getData().scanned_by, "</div>\n                            ");
		}
	},{
