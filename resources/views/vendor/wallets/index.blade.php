...
@section('subhead')
<title>Reward Wallets - TRACESCI</title>
@endsection
	...
	<div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
		...
		<script>
			...
			{	
				...
				download: false,
				formatter: function formatter(cell, formatterParams) {
					return "<div>\n                            <div class=\"font-medium whitespace-nowrap\">".concat(cell.getData().mobile, "</div>\n                            ");
				}
			},{
				title: "CODE DATA",
				minWidth: 200,
				...
				download: false,
				formatter: function formatter(cell, formatterParams) {
					return "<div>\n                            <div class=\"font-medium whitespace-nowrap\">".concat(cell.getData().type, "</div>\n                            ");
				}
			},
			{
				title: "POINTS",
				...
				download: false,
				formatter: function formatter(cell, formatterParams) {
					return "<div>\n                            <div class=\"font-medium whitespace-nowrap\">".concat(cell.getData().points, "</div>\n                            ");
				}
			},
			{
				title: "AMOUNT",
				...
				download: false,
				formatter: function formatter(cell, formatterParams) {
					return "<div>\n                            <div class=\"font-medium whitespace-nowrap\">".concat(cell.getData().amount, "</div>\n                            ");
				}
			},
			{
				title: "TXN ID",
				...
				download: false,
				formatter: function formatter(cell, formatterParams) {
					return "<div>\n                            <div class=\"font-medium whitespace-nowrap\">".concat(cell.getData().transaction_id, "</div>\n                            ");
				}
			},{
				title: "DATE",
				minWidth: 200,
