...
@section('subhead')
<title>Reward Schemes - TRACESCI</title>
@endsection

@section('subcontent')
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">Reward Schemes</h2>
	<div class="w-full sm:w-auto flex mt-4 sm:mt-0">
		<a href="{{ route('vendor-create-rewards') }}" class="btn btn-primary shadow-md mr-2">Add New Scheme</a>
		<div class="dropdown ml-auto sm:ml-0">
			<a href="{{ route('vendor-create-rewards') }}" class="btn px-2 box text-gray-700 dark:text-gray-300" aria-expanded="false">
...
<div class="intro-y box p-5 mt-5">
	<div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
		...
		<script>
			var tabulatorUrl =  '{{ route('vendor-rewards') }}';
			...
			{	
				...
				download: false,
				formatter: function formatter(cell, formatterParams) {
					return "<div>\n                            <div class=\"font-medium whitespace-nowrap\">".concat(cell.getData().from, "</div>\n                            ");
				}
			},{
				title: "TO",
				minWidth: 200,
				...
				download: false,
				formatter: function formatter(cell, formatterParams) {
					return "<div>\n                            <div class=\"font-medium whitespace-nowrap\">".concat(cell.getData().to, "</div>\n                            ");
				}
			},
			{
				title: "STATUS",
