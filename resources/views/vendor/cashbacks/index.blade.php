...
@section('subhead')
<title>Cashbacks - TRACESCI</title>
@endsection

@section('subcontent')
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">Cashbacks</h2>
	<div class="w-full sm:w-auto flex mt-4 sm:mt-0">
		<a href="{{ route('vendor-create-cashbacks') }}" class="btn btn-primary shadow-md mr-2">Add New Cashback</a>
		<div class="dropdown ml-auto sm:ml-0">
			<a href="{{ route('vendor-create-cashbacks') }}" class="btn px-2 box text-gray-700 dark:text-gray-300" aria-expanded="false">
...
<div class="intro-y box p-5 mt-5">
	<div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
		...
		<script>
			var tabulatorUrl =  '{{ route('vendor-cashbacks') }}';
