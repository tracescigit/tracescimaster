...
@section('subhead')
<title>Add Cashback - TRACESCI</title>
@endsection

@section('subcontent')
<div class="intro-y flex items-center mt-8">
	<h2 class="text-lg font-medium mr-auto">Add New Cashback</h2>
</div>
		...
		<form id="add-form">
			...
			<div class="intro-y box">
				<div class="flex flex-col sm:flex-row items-center px-7 py-5 border-b border-gray-200 dark:border-dark-5">
					<h2 class="font-medium text-base mr-auto">Cashback details</h2>
				</div>
				<div class="p-5">
			...
			<div class="intro-y box mt-4 codes-div">
				<div class="flex flex-col sm:flex-row items-center px-7 py-5 border-b border-gray-200 dark:border-dark-5">
